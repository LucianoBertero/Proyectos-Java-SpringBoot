...
public class ClienteController {
    ...
    public ResponseEntity<?> delete(@PathVariable Integer id){
        ...
        try {
            ClienteDto clienteDtoDelete =  clienteService.findById(id);



            clienteService.delete(clienteDtoDelete);
            return new ResponseEntity<>(clienteDtoDelete,HttpStatus.NO_CONTENT);
    ...
    @GetMapping("cliente/{id}")package com.std.ec.controller;
